...
export const SpotForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(res.errors) {
            ...
            dispatch(addImageToSpot(res, true, previewImg))
            if(urlCheck(imgOne)) dispatch(addImageToSpot(res, false, imgOne))
            if(urlCheck(imgTwo)) dispatch(addImageToSpot(res, false, imgTwo))
            if(urlCheck(imgThree)) dispatch(addImageToSpot(res, false, imgThree))
            if(urlCheck(imgFour)) dispatch(addImageToSpot(res, false, imgFour))
